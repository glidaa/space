...
// import designSystem from 'http://userscience.org/assets/gigantic-asteroids-about-crash-earth-3d-rendering.jpg';

<Meta title="Intro" />

<img src="http://userscience.org/assets/gigantic-asteroids-about-crash-earth-3d-rendering.jpg" width="100%" />

# Give me Space

The Space Storybook Design System is a reusable component library that helps Storybook contributors build UIs faster. The goal is to make building durable UIs more productive and satisfying.
...
'yarn add @space/design-system'

### **Use**

Import components you want into your UI

`import { Button, Badge } from '@space/design-system';`
